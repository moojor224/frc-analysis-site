...
export type Double_Elim_Round = "Finals" | "Round 1" | "Round 2" | "Round 3" | "Round 4" | "Round 5";
...
export type HabLine_2019 = "CrossedHabLineInSandstorm" | "CrossedHabLineInTeleop" | "None" | "Unknown";
export type History = {
    events: Event[];
    awards: Award[];
};
